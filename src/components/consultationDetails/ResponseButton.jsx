								...
								<>
									...
									>
										<div className="w-full flex flex-col">
											...
											<h2 className="text-2xl font-bold font-roboto my-2 text-carbon p-2">
												Subir Archivos
											</h2>
											<label htmlFor="file-upload" className="cursor-pointer m-2 rounded-full text-lightBlue shadow-xl active:scale-95 transition-transform transform bg-smokeWhite p-2">
												<FaPlus size={25} />
											</label>
											<input
												id="file-upload"
											...
											<div className="w-full mt-4">
												...
												<h3 className="text-2xl text-lightBlue font-semibold mb-2 mt-4">
