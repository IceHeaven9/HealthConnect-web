  ...
  return (
    <>
      ...
      >
        ...
        <section className="flex flex-col items-center justify-center gap-2 text-xl w-full">
          ...
          {doctors.map((doctor) => (
            <label
              key={doctor.id}
              className={`flex flex-col items-center w-full gap-2 p-4 m-3 rounded-xl border-[0.1rem] border-solid border-cakeBlue text-carbon cursor-pointer ${selectedDoctorId === doctor.id ? "bg-blue-200" : "bg-lightCakeBlue"}`}
            >
              <input
                type="radio"
                name="doctor"
      ...
      {selectedDoctor && (
        ...
        >
          <button className="text-2xl" onClick={() => setSelectedDoctor(null)}>
            <IoClose />
          </button>
          <div className="flex flex-col items-center justify-center gap-2 text-xl w-full">
            <h2 className="text-3xl p-6 text-center">
