...
export const DetailsConsultationPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#cad6ff]">
      ...
      <main className="bg-white p-6 rounded-lg shadow-md w-96 mx-4">
        ...
        {/* Fecha consulta */}
        <div>
          <h3 className="text-xl font-semibold mb-2">Fecha de la consulta:</h3>
        ...
        <input
          type="text"
          name="title"
          className="text-lg font-semibold mb-4 w-full h-auto break-words"
        ...
        <button
          className="mb-4 p-2 text-[#628eff] rounded"
          onClick={() => setShowConsultationFiles(!showConsultationFiles)}
        >
          {showConsultationFiles ? "Ocultar" : "Ver"} archivos adjuntos
        </button>
        ...
        >
          {showResponseFiles ? "Ocultar" : "Ver"} Respuesta
        </button>
        {showResponseFiles && (
          <div>
        ...
        >
          {showDoctor ? "Ocultar" : "Ver"} Doctor Asignado
        </button>
        {showDoctor && (
          <div className="flex items-center mb-4">
            <img
