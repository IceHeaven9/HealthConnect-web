...
export const NotFoundPage = () => {
  return (
    <div className="body relative bg-lightBlue text-smokeWhite font-['Open_Sans'] overflow-hidden flex flex-col items-center justify-center h-[100vh]">
      <div id="clouds">
      ...
      <div className="text-center flex flex-col items-center justify-center relative w-[80%] gap-4 min-h-screen mx-auto">
        ...
        <Link className="btn rounded-lg bg-smokeWhite relative inline-block w-full p-[5px] z-[10] text-[25px] my-0 mx-auto text-lightBlue no-underline mr-[10px]" to="/">Volver a Inicio</Link>
      </div>
    </div>
  );
};